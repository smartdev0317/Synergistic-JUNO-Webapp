...
import {
  ...
  useSynergisticWyndGaugeProposalHistory,
...
import WyndGaugeHistoryModal from './WyndGaugeHistoryModal'
import WyndGaugeHistoryButton from './WyndGaugeHistoryButton'

const WyndGaugeHistory = () => {
...
export default WyndGaugeHistory
