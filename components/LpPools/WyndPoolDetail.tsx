...
import { WyndLpFarmDataType } from 'data/types'
...
import WyndRewardValue from './Values/WyndRewardValue'
import { PoolInfoTab } from './Tab/PoolInfoTab'
import { LP_POOLS, VAULT_USER_DEPOSIT } from 'constants/keyNames'
import { useFetchWyndLpPool } from 'data/queries/wyndLpPoolsQueries'
import { WyndDepositTab } from './Tab/WyndDepositTab'
import { WyndClaimTab } from './Tab/WyndClaimTab'
import { WyndWithdrawTab } from './Tab/WyndWithdrawTab'

interface PropsType {
  opened: boolean
  onToggle: Function
  data: WyndLpFarmDataType
  hideEmpty: boolean
  search: string
}

const WyndPoolDetail = ({
  opened,
  onToggle,
  data,
  hideEmpty,
    ...
    >
      ...
      >
        ...
        <div className="col-span-2 flex justify-end h-full items-center">
          <WyndRewardValue type={LP_POOLS} base={base} pair={pair} />
        </div>
      </button>
      <div
        className={`${
